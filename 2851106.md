...
3	| HonestSignStatus| Статус "Честного знака" у товара                                     	| 0..1    | Int        |                | 0 - нет данных</br> 1 - на товаре имеется валидный КМ </br> 2 - требуется маркировка </br> 3 - требуется проверка валидности кода марикровки
