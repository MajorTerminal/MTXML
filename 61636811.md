# Множественная заявка на отгрузку товаров со склада

## Назначение и описание
Передается из ERP в WMS для создания нескольких заявок на отгрузку товаров, а так же при необходимости обновления уже существующих документов.
...
2       | DocExtField1        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField2        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField3        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField4        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField5        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField6        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField7        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField8        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField9        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocExtField10       | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | DocLotFiled1        | Расширенные данные партии                                  | 0..1    | String     | 50          |                                                           
2       | DocLotFiled2        | Расширенные данные партии                                  | 0..1    | String     | 50          |                                                           
2       | DocLotFiled3        | Расширенные данные партии                                  | 0..1    | String     | 50          |                                                           
2       | DocLotFiled4        | Расширенные данные партии                                  | 0..1    | String     | 50          |                                                           
2       | DocLotFiled5        | Расширенные данные партии                                  | 0..1    | String     | 50          |
2       | PartCode        | Порядковый номер части документа отгрузки                                         | 0..1    | Integer     |           |                                                           
2       | PartName        | Номер части документа отгрузки                                         | 1..1    | String     | 50          |                                                           
2       | PartActionType        | Тип действия части  документа отгрузки                                      | 0..1    | String     | 20          |               
2       | PartExtField1        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField2        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField3        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField4        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField5        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField6        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField7        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField8        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField9        | Расширенные данные                                         | 0..1    | String     | 80          |                                                           
2       | PartExtField10       | Расширенные данные                                         | 0..1    | String     | 80          | 
...
3       | ShipToOnlyFind         | Флаг поиска. Отключает добавление отсутствующих данных     | 0..1    | Boolean    |             |                                                           
3       | ShipToCode             | Уникальный код получателя                                  | 0..1    | String     | 20          |                                                           
3       | ShipToName             | Наименование                                               | 0..1    | String     | 100         |                                                           
3       | ShipToCity             | Город                                                      | 0..1    | String     | 30          |                                                           
3       | ShipToAddress          | Адрес                                                      | 0..1    | String     | 250         |                                                           
3       | ShipToContact          | Контактное лицо                                            | 0..1    | String     | 250         |                                                           
3       | ShipToContactPhone     | Телефон контактного лица                                   | 0..1    | String     | 100         |                                                           
3       | ShipToEmail            | E-mail контактного лица                                    | 0..1    | String     | 200         |                                                           
3       | ShipToIndex            | Индекс                                                     | 0..1    | String     | 20          |                                                           
3       | ShipToCountry          | Страна                                                     | 0..1    | String     | 30          |                                                           
3       | ShipToPriority         | Приоритет                                                  | 0..1    | Integer    |             |                                                           
3       | ShipToComment          | Комментарий                                                | 0..1    | String     | 250         |
3       | ShipToDeliveryTerminal | Терминал доставки  					| 0..1    | String     | 50          |                                                          
2       | ShipToAgent      | Агент грузополучателя                                      | 0..1    |            |             |                                                           
3       | ShipToOnlyFindAgent         | Флаг поиска. Отключает добавление отсутствующих данных     | 0..1    | Boolean    |             |                                                           
3       | ShipToAgentFillByShipTo         | Флаг заполнения. заполняет данными из блока ShipTo     | 0..1    | Boolean    |             |                                                           
3       | ShipToCodeAgent            | Уникальный код адреса                                      | 0..1    | String     | 20          |                                                           
3       | ShipToNameAgent             | Наименование                                               | 0..1    | String     | 100         |                                                           
3       | ShipToCountryAgent             | Город                                                      | 0..1    | String     | 30          |                                                           
3       | ShipToCityAgent             | Город                                                      | 0..1    | String     | 30          |                                                           
3       | ShipToPostCodeAgent          | Адрес                                                      | 0..1    | String     | 250         |                                                           
3       | ShipToAddressAgent          | Контактное лицо                                            | 0..1    | String     | 250         |                                                           
3       | ShipToContactAgent     | Телефон контактного лица                                   | 0..1    | String     | 100         |                                                           
3       | ShipToContactPhoneAgent            | E-mail контактного лица                                    | 0..1    | String     | 200         |                                                           
3       | ShipToEmailAgent            | Индекс                                                     | 0..1    | String     | 20          |                                                           
3       | ShipToRegionAgent          | Страна                                                     | 0..1    | String     | 30          |                                                           
3       | ShipToDeliveryTerminalAgent         | Приоритет                                                  | 0..1    | Integer    |             |                                                           
3       | ShipToCommentAgent          | Комментарий                                                | 0..1    | String     | 250         |                                                                                                                    
...
## Описание схемы
<a href="https://github.com/MajorTerminal/MTXML/blob/master/XSD/MT_ShipmentMultiPart.xsd" rel="XSD">![Foo](https://user-images.githubusercontent.com/22858622/134012526-73d1b128-a2cd-4d14-8a13-10f81a57c04f.png)</a>

## Пример XML
```
<ns0:ShipmentMultiPart xmlns:ns0="http://MT.BTS.DataExchange.MT_ShipmentMultiPart">
	<Row>
		...
		<PartName>SH10056</PartName>
		<PartActionType>PODB_I</PartActionType>
		<ShipTo>
			<Code>M19</Code>
		...
		<DocExtField1>Z10000L</DocExtField1>
	...
	<Row>
		...
		<ShipmentDate>2020-07-17 00:00:00.000</ShipmentDate>
		<NecessaryDate>2020-07-20 00:00:00.000</NecessaryDate>
		<PartName>SH10057</PartName>
		<PartActionType>PODB_S</PartActionType>
		<ShipTo>
			<Code>M2</Code>
			<Name>Магазин М2</Name>
			<City>Москва</City>
			<Address>Преображенская площадь д.2</Address>
			<Contact>Фамилия Имя</Contact>
			<ContactPhone>8(495)34444444</ContactPhone>
			<Email>lastname@email.com</Email>
			<Index>190000</Index>
		...
		<DeliveryAgent>LTL</DeliveryAgent>
		<PartExtField1>Z20000L</PartExtField1>
		<Article>7281</Article>
		<UOM>ШТ</UOM>
		<Quantity>50</Quantity>
		<BestBeforeDate>2020-12-31 00:00:00.000</BestBeforeDate>
