...
2       | PackageDimensions | Весогабаритные характеристики грузомест                                   | 0..1    |            |             |
3       | Package           | Характеристики грузоместа                                                 | 0..n    |            |             |
4       | SerialNo          | Серийный номер грузоместа                                                 | 1..1    | String     | 20          |
4       | PackageType       | Тип грузоместа (например PALLET или BOX)                                  | 1..1    | String     | 20          |
4       | Cubage            | Объем грузоместа                                                          | 1..1    | Decimal    |             |
4       | Weight            | Вес грузоместа                                                            | 1..1    | Decimal    |             |
4       | Length            | Длина грузоместа                                                          | 1..1    | Decimal    |             |
4       | Width             | Ширина грузоместа                                                         | 1..1    | Decimal    |             |
4       | Height            | Высота грузоместа                                                         | 1..1    | Decimal    |             |
...
<ns0:PackingReport xmlns:ns0="https://MT.BTS.DataExchange.MT_PackingReport">
  ...
  <PackingHeader>
    ...
    <MarketplaceCode3>00000000-1111-2</MarketplaceCode3>
  </PackingHeader>
  <PackingRows>
    <PackingRow>
  ...
  <PackageDimensions xmlns="http://MT.BTS.DataExchange.MT_PackingReport">
    <Package>
      <SerialNo>P2400590853</SerialNo>
      <PackageType>PALLET</PackageType>
      <Cubage>0.81600000000000000000</Cubage>
      <Weight>17.00000000000000000000</Weight>
      <Length>1.20000000000000000000</Length>
      <Width>0.80000000000000000000</Width>
      <Height>0.85000000000000000000</Height>
    </Package>
    <Package>
      <SerialNo>P2400590818</SerialNo>
      <PackageType>BOX</PackageType>
      <Cubage>0.00980100000000000000</Cubage>
      <Weight>0.01000000000000000000</Weight>
      <Length>0.33000000000000000000</Length>
      <Width>0.27000000000000000000</Width>
      <Height>0.11000000000000000000</Height>
    </Package>
  </PackageDimensions>
  <SealRows>
    <SealRow>
