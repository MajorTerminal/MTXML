...
6       | MarketplaceProduct | Идентификатор товара создаваемый на стороне маркетплейса                         | 1..1    | String     | 30 |
6       | CustomerProduct | Идентифиатор товара сгенерированный на стороне продавца                             | 1..1    | String     | 30 |
6       | UnitOfMeasure | Единица измерения варианта идентификатора маркетплейса.  Если не заполнена - заполняется как базовая ЕИ товара | 1..1    | String     | 30 |
