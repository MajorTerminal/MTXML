...
3       | GTIN               | GTIN товара                                                                      | 0..1    | String     | 100         |               
...
3       | Seller             | Данные продавца                                                                  | 0..1    | String     | 110         |                           
3       | MarkedByHS         | Метка о проставлении "Честный знак"                                              | 0..1    | Integer    |             |
3       |MarkingGroup        | Группа маркировки ГИС МТ                                                         | 0..1    | String     | 20         |
...
3       | MarketplaceIdentifierList | Идентификаторы товара на стороне маркетплейса                             | 0..1     |            | |
4       | MarketplaceIdentifier | Идентификаторы товара на стороне маркетплейса                                 | 1..n    |            | |
5       | MarketplaceCode | Код маркетплейса                                                                    | 1..1    | String     | 30 |
5       | MarketplaceProduct | Идентификатор товара создаваемый на стороне маркетплейса                         | 0..1    | String     | 100 |
5       | CustomerProduct | Идентифиатор товара сгенерированный на стороне продавца                             | 0..1    | String     | 10 |
5       | UnitOfMeasureCode | Единица измерения варианта идентификатора маркетплейса.  Если не заполнена - заполняется как базовая ЕИ товара | 1..1    | String     | 30 |
